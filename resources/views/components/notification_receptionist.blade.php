            ...
            data.forEach(n => {
                ...
                if (!shownNotifications.includes(uniqueKey)) {
                    ...
                    notificationQueue.push({
                        ...
                        message: n.message || "A new notification has arrived.",
                        key: uniqueKey
                    });
                }
            });
...
function generateNotificationKey(n) {
    ...
    try {
        return `notif_${n.type || 'General'}_${idPart}_${btoa(unescape(encodeURIComponent(msgPart)))}`;
    } catch {
        return `notif_${n.type || 'General'}_${idPart}_fallback`;
    }
}
...
function showNotification(title, message, key) {
    ...
    // prevent duplicates from stacking visually
