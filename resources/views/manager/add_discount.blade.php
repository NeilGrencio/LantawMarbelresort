    ...
    <div id="main-layout">
        ...
        <form method="post" action="{{url('manager/add_discount')}}">
            ...
            <div class="form-container">
                ...
                <input id="percent" name="percent" type="text" placeholder="0.20" value="{{old('percent')}}"/>
                ...
                <input id="flat" name="flat" type="text" placeholder="200" value="{{old('flat')}}"/>
                ...
                <select id="status" name="status" required>
                    <option value="" disabled selected>Select Discount Status</option>
