...
<body>
    <div id="layout">
        ...
        <div id="main-layout">
            ...
            <form action="{{ url('manager/save_room') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-container">
                    ...
                    <div class="room-card">
                        <div id="room-image">
                            <img id="imagePRV" src="{{ asset('images/photo.png') }}" style="width:100%; height:100%; object-fit:cover;">
                        </div>
                    ...
                    <input type="text" id="roomnum" name="roomnum" placeholder="101" required>

                    <label for="description">Description:</label>
                    <textarea id="description" name="description" rows="4" placeholder="Enter a room description..." required ></textarea>

                    <label for="price">Room Price:</label>
                    <input type="text" id="price" name="price" placeholder="₱ 4500.00" required>

                    <label for="roomtype">Room Type:</label>
                    <input type="text" id="roomtype" name="roomtype" placeholder="Singles" required>

                    <label for="roomcapacity">Room Capacity:</label>
                    <input type="text" id="roomcapacity" name="roomcapacity" placeholder="1" values={{ old('roomcapacity', $room->roomcapacity ?? '' )}} required>
