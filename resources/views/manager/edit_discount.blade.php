        ...
        <div id="main-layout">
            ...
            <form method="post" action="{{url('manager/edit_discount/' . $discount->discountID)}}">
                ...
                <div class="form-container">
                    ...
                    <input id="name" name="name" type="text" placeholder="Senior Discount" required value="{{old('name', $discount->name)}}"/>

                    <label for="amount">Discount Amount</label>
                    <input id="amount" name="amount" type="text" placeholder="0.20" required value="{{old('amount', $discount->amount ?? '')}}"/>
