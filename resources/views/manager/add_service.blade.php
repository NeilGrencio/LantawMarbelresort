...
<body>
    <div id="layout">
        ...
        <div id="main-layout">
            ...
            <form action="{{url('manager/add_service')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div id="button-container">
                    <button id="cancel" type="button" data-url={{url('manager/service_list')}}>Cancel</button>
