                        ...
                        <div class="search-container">
                            <form action="{{ route('receptionist.search_checkin') }}" method="GET">
                                ...
                                @if(request()->has('search') && request('search') !== '')
                                    <a href="{{ route('receptionist.search_checkin') }}" class="reset-btn">Clear Search</a>
                                @endif
                            </form>
                        </div>
                        <div id="add-container">
                            <div class="add-action">
                                <i id="add-action" class="fa-solid fa-list-ol fa-2x" data-url="{{ url('receptionist/check-in-out') }}" style="cursor:pointer;"></i>
                                <small>Return</small>
                            </div>
                            <div class="add-action">
                                <i id="add-action" class="fas fa-hotel fa-2x" data-url="{{ url('receptionist/checkout_list') }}" style="cursor:pointer;"></i>
