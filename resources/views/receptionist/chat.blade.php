        ...
        <div id="main-layout">
            <div class="chat-list-container">
                ...
                <div class="chat-list">
                    @foreach ($chat as $chats)
                        ...
                        <div class="chat-list-card" data-chatID="{{ $chats->chatID }}" data-guest="{{ $chats->gID }}"
                            data-gavatar="{{ $g_avatar_url }}" data-gname="{{ $g_fullname }}"
                            data-chat="{{ $chats->chat }}" data-chatdate="{{ $chats->datesent }}"
                            data-staff="{{ $chats->sID }}" data-savatar="{{ $s_avatar_url }}"
                            data-sname="{{ $s_fullname }}" data-reply="{{ $chats->reply }}"
                            data-replydate="{{ $chats->datereplied }}" onclick="selectMessage(this)">
            ...
            <div class="chat-area">
                ...
                @if ($latestchat)
                    ...
                    <form id="reply-form" method="POST" action="{{ route('receptionist.chat_send') }}">
                        @csrf
